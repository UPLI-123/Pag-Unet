...
parser.add_argument('--image_path', default='./image/pascal01.jpg',
                    help='Image path which has to be parsed')
parser.add_argument('--ckp_path', default='./cpk/checkpoint.pth_pascal.tar',
                    help='Config file for the experiment')
...
def infer(task):
    ...
    save_path = os.path.join(args.save_dir, "PASCAL_"+task + '.png')
