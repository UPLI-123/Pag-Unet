...
def train_phase(p, args, train_loader, test_dataloader, model, criterion, optimizer, scheduler, epoch, iter_count,device):
    ...
    for i, cpu_batch in enumerate(tqdm(train_loader)):
        ...
        if eval_bool:
            ...
            curr_result = test_phase(p, test_dataloader, model, criterion, iter_count,device)
